namespace DotNetZipAdditionalPlatforms.Zip
{
    ...
    /// actual AES key used is derived from the <see cref="P:DotNetZipAdditionalPlatforms.Zip.ZipEntry.Password" /> via an
    ...
    public enum EncryptionAlgorithm
    {
        ...
        /// <summary>
        /// The Pkzip weak encryption algorithm.
        /// </summary>
        PkzipWeak,

        /// <summary>
        /// The WinZip AES 128 encryption algorithm. 
        /// </summary>
        WinZipAes128,

        /// <summary>
        /// The WinZip AES 256 encryption algorithm. 
        /// </summary>
        WinZipAes256,

        /// <summary>
        /// An unsupported encryption algorithm. 
        /// </summary>
        Unsupported
    }
}
