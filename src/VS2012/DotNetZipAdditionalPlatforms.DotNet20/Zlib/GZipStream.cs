namespace DotNetZipAdditionalPlatforms.Zlib
{
    ...
    public class GZipStream : Stream
    {
        ...
        {
            byte[] sourceArray = (this.Comment == null) ? null : iso8859dash1.GetBytes(this.Comment);
            byte[] buffer2 = (this.FileName == null) ? null : iso8859dash1.GetBytes(this.FileName);
        ...
        public int BufferSize
        {
            ...
            set
            {
                ...
                if (value < 0x400)
                {
                    throw new ZlibException(string.Format(CultureInfo.InvariantCulture, "Don't be silly. {0} bytes?? Use a bigger buffer, at least {1}.", value, 0x400));
                }
